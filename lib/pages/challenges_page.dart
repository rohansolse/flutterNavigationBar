...
import 'package:navigation_bar/core/getX/controllers/challenges_page_controller.dart';
import 'package:navigation_bar/core/utils/common_widgets.dart';
import 'package:navigation_bar/core/utils/custom_vext_view.dart';
import 'package:navigation_bar/core/utils/enums.dart';
import 'package:navigation_bar/core/utils/theme_data.dart';

class ChallengesPageUI extends StatelessWidget {
  const ChallengesPageUI({super.key});
            ...
            return Column(
              children: [
                ...
                Padding(
                  ...
                  child: Row(children: [
                    Image.asset("icons/ic_wallet.png",
                    ...
                    Container(
                      ...
                      decoration: ShapeDecoration(
                        ...
                        shape: OvalBorder(
                          side: BorderSide(
                              width: 0.50.sp, color: const Color(0x19ECECEC)),
                        ),
                        shadows: [
                          BoxShadow(
                        ...
                        children: controller.dataItemList
                            .mapIndexed((index, item) => Row(
                                  children: [
                                    GestureDetector(
                                      onTap: () {
                                        for (var element
                                            ...
                                            in controller.dataItemList.value) {
                                    ...
                                    if (index + 1 !=
                                        controller.dataItemList.length) ...[
                                      Padding(
                        ...
                        child: Stack(
                          children: controller.cardDataList
                              .mapIndexed((index, item) => Padding(
                                    padding:
                                        EdgeInsets.only(top: index * 70.sp),
                                    child: SizedBox(
                                        height: 220.h,
