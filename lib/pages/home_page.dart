                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    ...
                                    alignment: Alignment.center,
                                    decoration: BoxDecoration(
                                      color: MyAppColors.primaryExtraLightGreenColor,
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Container(
                                          ...
                                          height: 15.sp,
                                          decoration:
                                              BoxDecoration(color: MyAppColors.primaryLightThemeColor, borderRadius: BorderRadius.circular(7.sp)),
                                          alignment: Alignment.center,
                                          child: CustomText(
                                            text: "New",
                                            fontWeight: FontWeight.w700,
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        alignment: Alignment.center,
                                        decoration:
                                            BoxDecoration(color: MyAppColors.primaryLightBlueColor, borderRadius: BorderRadius.circular(10.sp)),
                                        child: CustomText(
                                          text: "View All",
                                          textSize: 10.sp,
                                          fontFamily: FontFamily.sfProRegular,
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    color: item.isSelected ?? false
                                                        ...
                                                        : MyAppColors.primaryLightBlackColor,
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    padding: EdgeInsets.all(12.sp),
                                                    decoration: BoxDecoration(
                                                      border: Border.all(color: MyAppColors.primaryLightThemeColor),
                                                      shape: BoxShape.circle,
                                                    ),
                                                    child: Image.asset(
                                                      "icons/ic_tick.png",
                                                                    ...
                                                                    ...List<Widget>.generate(min(item.participant?.length ?? 0, 4), (index) {
                                                                      if (index <
                                                                          (((item.participant?.length ?? 0) <= 4)
                                                                              ...
                                                                              : ((min(item.participant?.length ?? 0, 4) - 1)))) {
                                                                        return Padding(
                                                                          padding: EdgeInsets.only(left: index * 15.w),
                                                                          child: Image.asset(item.participant?[index] ?? '',
