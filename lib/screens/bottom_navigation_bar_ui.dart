...
import 'package:navigation_bar/core/getX/controllers/bottom_navigation_bar_controller.dart';
      ...
      builder: (controller) {
        return Scaffold(
          ...
          bottomNavigationBar: Container(
            decoration:
                BoxDecoration(gradient: MyAppColors.customAppLinearColor),
            child: BottomNavigationBar(
              backgroundColor: Colors.transparent,
              selectedLabelStyle: TextStyle(
                  fontFamily: FontFamily.sfProSemiBold.name,
                  fontSize: 8.sp,
                  color: MyAppColors.primaryWhiteColor,
                  fontWeight: FontWeight.w800),
              unselectedLabelStyle: TextStyle(
                  fontFamily: FontFamily.sfProRegular.name,
                  fontSize: 8.sp,
