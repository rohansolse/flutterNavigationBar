...
class HomePageController extends GetxController {
  ...
  RxList<DataListBasedOnSelectionOfItem> timeBoxDataList =
      RxList<DataListBasedOnSelectionOfItem>([
    DataListBasedOnSelectionOfItem(
      ...
      status: "ONGOING",
      subTitle:
          "Attended a printmaking workshop at NGMA, a week's work. Loose old sketches in my sketchbook turned into this design.",
